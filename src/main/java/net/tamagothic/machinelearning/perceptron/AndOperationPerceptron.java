...
public class AndOperationPerceptron {
	private final SimplePerceptron perceptron;

	public AndOperationPerceptron(int inputUnitSize, int outputUnitSize, double learningRate) {
	...
	public static void main(String[] args) {
		AndOperationPerceptron operator = new AndOperationPerceptron(2, 1, 0.3);
		operator.train();
